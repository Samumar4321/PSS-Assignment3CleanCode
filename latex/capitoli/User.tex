\section{Classe User.java}
    ...
    Oltre a rappresentare l'utente, la classe utilizza l'interfaccia \texttt{Parcelable} di Android per permettere lo scambio di oggetti User in maniera efficiente tra le varie attività dell'applicazione.
