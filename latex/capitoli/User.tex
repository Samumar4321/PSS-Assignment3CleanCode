\section{Classe User.java}
    ...
    \subsection{Analisi di Clean Code}
        ...
        La classe presenta un singolo problema di hardcoding, ovvero l'uso della stringa \texttt{"unknown"} per rappresentare un valore di attributo non definito.
        ...
        La variabile \texttt{age} è adatta ed esplicativa di cosa contiene, ma generalmente è preferibile utilizzare l data di nascita in rispetto all'età, 
        per evitare il costante aggiornamento.
